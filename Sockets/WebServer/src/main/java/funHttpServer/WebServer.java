      ...
      if (request == null) {
        ...
        if (request.length() == 0) {
          ...
          try {
              ...
              num1 = 1;
              goodInput = false;
              error = error+"num1 parameter malformed with error: "+e.getMessage()+"<br>Using default value of 1<br>";
          }
          try {
              ...
              num2 = 2;
              goodInput = false;
              error = error+"num2 parameter malformed with error: "+e.getMessage()+"<br>Using default value of 2<br>";
          }
